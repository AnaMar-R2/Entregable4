  ...
  return (
    <article className='user'>
      ...
      <div className='user__btn-s'>
        <button className='user__btn user__btn-delete' onClick={handleDelete}><img src="./../../public/delete.png" alt="Delete" /></button>
        <button className='user__btn user__btn-update' onClick={handleUpdate}><img src="./../../public/edit.png" alt="Update" /></button>
      </div>
    </article>
  )
}
